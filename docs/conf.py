...
from dtos.__metadata__ import __project__ as project
from dtos.__metadata__ import __version__ as version
...
# -- Project information -----------------------------------------------------
author = "Jolt Org"
release = os.getenv("_DTOS_DOCS_BUILD_VERSION", version.rsplit(".")[0])
...
html_theme_options = {
    ...
    "github_url": "https://github.com/jolt-org/dtos",
    "nav_links": [
        {"title": "Home", "url": "https://dtos.jolt.rs"},
        {"title": "Docs", "url": "https://docs.dtos.jolt.rs"},
        {"title": "Code", "url": "https://github.com/jolt-org/dtos"},
    ],
    "light_css_variables": {
        # RGB
